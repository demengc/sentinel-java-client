 ...
 *
 * <p>Use {@link #builder()} to construct an instance. The {@code product} field is required; all
 * others are optional. If {@code server} is not set, it defaults to the machine fingerprint
 * generated by {@link MachineFingerprint#generate()}.
 */
public final class ValidationRequest {
   ...
   *
   * <p>Required fields: {@link #product(String)}.
   */
